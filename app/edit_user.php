...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="update anggota set id_anggota='$id_anggota',
			username='$username',
			password='$password',
			nama='$nama',
			level='$level'
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
       ...
       <div class="form-floating mb-3">
            <input type="hidden" name="id_anggota" class="form-control" value="<?php echo $data['id_anggota']; ?>" required />

            <input type="text" name="username" class="form-control" value="<?php echo $data['username']; ?>" required />
            <label for="action">Username</label>
        </div>
     ...
     <div class="form-floating mb-3">
            ...
            <label for="action">Nama User</label>
        </div>
                          <div class="form-floating mb-3">
                                <select class="form-select" name="level" 
                                    aria-label="Floating label select example" required>
                                    <option value="<?php echo $data['level']; ?>">user</option>
                                    <option>user</option>
                                    <option>admin</option>

                                </select>

                                <label for="status2">Level User</label>
                            </div>

        <button type="submit" name="submit" class="btn btn-primary">Submit</button>
        <a href="menu_admin.php" class="btn btn-success">Batal</a>
    </form>
</div>
</div>
